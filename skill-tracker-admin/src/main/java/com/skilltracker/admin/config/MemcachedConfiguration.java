...
import com.skilltracker.admin.cache.Memcached;
...
public class MemcachedConfiguration implements CachingConfigurer {
    ...
    @Value("${memcached.cache.expirations}")
    ...
    private Collection<Memcached> internalCaches() throws IOException {
        ...
        caches.add(new Memcached("fullstackEngineers", memcachedAddresses, expirationSec));
        return caches;
    }
